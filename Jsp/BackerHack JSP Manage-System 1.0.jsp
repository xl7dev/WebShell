...
<%!
final String APP_NAME="BackerHack JSP Manage-System 1.0";
...
void mainMenu(JspWriter out,String web_Site)throws Exception{
    ...
    out.println("<tr><td bgcolor=menu><a href='http://blog.csdn.net/BackerHack' target=FileFrame>About nonamed(BackerHack)</a></td></tr>");
    out.println("</table>");
}
